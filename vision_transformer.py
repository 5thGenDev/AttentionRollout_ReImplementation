...
### For Hydra Attebbtion, code was copied from https://github.com/robflynnyh/hydra-linear-attention/blob/main/hydra.py ###
...
# As long as # Head (H) = # Token, computation complexity is linear
...
### The following 2 classes unique to SiT: Self-Supervised Transformer {2021} ###
